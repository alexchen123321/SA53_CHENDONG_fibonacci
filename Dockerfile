#FROM centos:7
#
#COPY ./target/hola-dropwizard-1.0.jar /home
#COPY ./conf/app.yml /home
#COPY ./jdk-16.0.2_linux-x64_bin.rpm /opt
#EXPOSE 8000/tcp
##RUN   rpm -ivh /opt/jdk-16.0.2_linux-x64_bin.rpm
##WORKDIR /home
##
##CMD ["java","hola-dropwizard-1.0.jar" , "server" , "app.yml" ]
#
#
...
#   https://download.oracle.com/java/17/jdk-linux-x64_bin.tar.gz
#
